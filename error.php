...
<html>
    <head>
        ...
        <title>Fehler - Notentabelle</title>
    ...
    <body>
        ...
        <?php
            ...
            /*
                ...
                2: Benoetigt Cookies
                3: Browser wird nicht unterstuetzt
            ...
            */
            ...
            if($error === -1) {
                ...
                echo 	"<h2>Browser nicht unterstützt!</h2>" .
                        "<div class='text'>" . 
                            "<p>Notentabelle unterstützt diesen Webbrowser nicht.</p>" .
                            "<p>Um Notentabelle benutzen zu können, benutzen Sie bitte einen moderneren Webbrowser.</p>" .
                        "</div>";
